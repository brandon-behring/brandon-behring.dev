...
- **2026-06-19** — Cross-property visual/quality recon: 8 deployed properties × viewport/scheme matrix → 9 improvement issues filed across the family (#29–#33 here · ssm#48 · dml#46 · scaffold#161 · math-guides#1 · dlai#1) → [session](docs/sessions/2026-06-19--cross-property-visual-recon.md)
